...
=== FLOW REWARDS (₣) ===
⚠️ CRITICAL: ₣ FLOW נצבר רק מפעילות קהילתית. ביצוע משימות משפחתיות מזכה ב-₪ (שקלים מבנק המשפחה) — לא ב-₣ FLOW!
לעולם אל תגיד שמשימות נותנות ₣ FLOW — זה שגוי לחלוטין.

כל משפחה יש לה ארנק FLOW אישי (⚡). ₣ נצבר רק מפעילות בלשונית "קהילה":
- מימוש מבצע קהילתי (לחצן "מימשתי את המבצע" בחדשות): +3₣
- רכישת חבילה קהילתית (לחצן "רכישה" בחדשות): +18₣
- ביקורת חיובית (4-5⭐) על עסק בקהילה: +7₣
- הצטרפות לקהילה חדשה: +₣ (בונוס הצטרפות)
- הפניית חבר/משפחה לקהילה: +₣ (בונוס הפניה)
- כניסה יומית לאפליקציה (אוטומטי): +₣ קטן

**מימוש ₣ להנחה**: לחצן "ארנק FLOW" בלשונית קהילה → בחרו כמות (מינימום 100₣) → קבלו קוד הנחה FL... → הציגו לעסק בקהילה.
