...
                    </tr>
                </table>
                <h2 style="font-size: 22px; margin: 15px 0 0 0; color: #334155;">הזמנת רכש <span dir="ltr">(Purchase Order)</span></h2>
...
            // מוסיפים Padding קטן רק בשביל הריווח במסמך הסופי
...
            const opt = { 
                margin: [10, 10, 10, 10], // שוליים תקניים למניעת חיתוך
                filename: 'order.pdf', 
...
    // פעולת ההורדה בפועל - יוצרת אובייקט "וירטואלי" להורדה שמונע דפים לבנים
...
            if (!isLoaded) throw new Error('PDF library failed to load');
            ...
            // התיקון ל-PDF יורד ריק!
            // אנחנו שמים את התוכן בקונטיינר שהוא Fixed אבל בתוך תחומי המסך ועם z-index שלילי
