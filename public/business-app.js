...
                <td style="padding: 8px; text-align: right; border: 1px solid #cbd5e1; font-weight: bold; color: #1e293b;" dir="rtl">${safeStr(i.name).replace(/ /g, '&nbsp;')}&rlm;</td>
                <td style="padding: 8px; text-align: center; border: 1px solid #cbd5e1; font-weight: bold; color: #4f46e5;" dir="rtl">${i.quantity}&nbsp;${safeStr(i.unit)}</td>
...
    }
    ...
    // שימוש בטבלאות פשוטות למידע כדי למנוע קפיצות וריווחים של בלוקים
    return `
        <div style="direction: rtl; font-family: Arial, sans-serif; color: #1e293b; background: white; width: 800px; margin: 0 auto; box-sizing: border-box; padding: 30px;">
            
            <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom: 2px solid #4f46e5; margin-bottom: 20px; padding-bottom: 10px;">
                <tr>
...
                        <span style="font-size: 24px; font-weight: 900; color: #4f46e5; font-family: 'Arial Black', sans-serif; vertical-align: middle;">
...
                        <h2 style="margin: 0; font-size: 20px; color: #334155;">הזמנת רכש</h2>
                        <div style="font-size: 12px; color: #64748b; margin-top: 2px;">Purchase Order</div>
                        <div style="margin-top: 8px; font-size: 13px; color: #0f172a;">מספר הזמנה:&nbsp;<b dir="ltr" style="color: #4f46e5;">#${orderInfo.orderId || 'חדש'}</b></div>
                    </td>
                </tr>
            </table>
...
                <tr>
                    <td style="width: 48%; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 12px; vertical-align: top; text-align: right;">
                        <h3 style="margin: 0 0 8px 0; color: #4f46e5; font-size: 14px; border-bottom: 1px solid #cbd5e1; padding-bottom: 4px;">פרטי הלקוח (המזמין):</h3>
                        <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 13px;">
                            <tr><td style="padding-bottom: 4px; font-weight: bold; width: 80px;">שם העסק:</td><td style="padding-bottom: 4px;">${safeStr(currentGroup.name)}&rlm;</td></tr>
                            <tr><td style="padding-bottom: 4px; font-weight: bold;">איש קשר:</td><td style="padding-bottom: 4px;">${safeStr(currentUser.nickname)}&rlm;</td></tr>
                            ${orderInfo.branchName ? `<tr><td style="padding-bottom: 4px; font-weight: bold;">עבור סניף:</td><td style="padding-bottom: 4px;">${safeStr(orderInfo.branchName)}&rlm;</td></tr>` : ''}
                            ${orderInfo.customerNumber ? `<tr><td style="padding-bottom: 4px; font-weight: bold;">מס' לקוח:</td><td style="padding-bottom: 4px; color: #4f46e5; font-weight: bold;" dir="ltr">${safeStr(orderInfo.customerNumber)}</td></tr>` : ''}
                            <tr><td style="padding-top: 6px; font-weight: bold; color: #64748b;">הופק ב:</td><td style="padding-top: 6px; color: #64748b;" dir="ltr">${new Date().toLocaleDateString('he-IL')} ${new Date().toLocaleTimeString('he-IL', {hour:'2-digit', minute:'2-digit'})}</td></tr>
                        </table>
                    </td>
                    <td style="width: 4%;"></td>
                    <td style="width: 48%; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 12px; vertical-align: top; text-align: right;">
                        <h3 style="margin: 0 0 8px 0; color: #0f172a; font-size: 14px; border-bottom: 1px solid #cbd5e1; padding-bottom: 4px;">פרטי הספק:</h3>
                        <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 13px;">
                            <tr><td style="padding-bottom: 4px; font-weight: bold; width: 50px;">לכבוד:</td><td style="padding-bottom: 4px;">${safeStr(orderInfo.supplierName)}&rlm;</td></tr>
                            ${orderInfo.supplierPhone ? `<tr><td style="padding-bottom: 4px; font-weight: bold;">טלפון:</td><td style="padding-bottom: 4px;" dir="ltr">${safeStr(orderInfo.supplierPhone)}</td></tr>` : ''}
                            ${orderInfo.supplierEmail ? `<tr><td style="padding-bottom: 4px; font-weight: bold;">דוא"ל:</td><td style="padding-bottom: 4px;" dir="ltr">${safeStr(orderInfo.supplierEmail)}</td></tr>` : ''}
                        </table>
                    </td>
                </tr>
            </table>

            <div style="margin-bottom: 15px; font-size: 13px; line-height: 1.4; color: #334155; text-align: right;">
                <b>שלום רב,</b><br>
...
                        <th style="padding: 8px; border: 1px solid #cbd5e1; text-align: right; width: 45%;">תיאור פריט</th>
...
            </table>
            
            <table width="100%" cellpadding="0" cellspacing="0" style="border-top: 2px solid #cbd5e1; padding-top: 10px;">
                <tr>
                    <td style="text-align: right;">
                        <div style="color: #64748b; font-size: 11px;">* ייתכנו שינויים קלים במחיר הסופי בהתאם לשקילה ולמחירון העדכני.</div>
                    </td>
                    <td style="text-align: left;">
                        <h2 style="margin: 0; font-size: 18px; color: #0f172a;">סה"כ לתשלום משוער:&nbsp;<span dir="ltr" style="color: #4f46e5;">₪${(orderInfo.totalAmount || orderInfo.total || 0).toFixed(2)}</span></h2>
                    </td>
                </tr>
            </table>
        </div>
...
                html2canvas: { scale: 2, useCORS: true, windowWidth: 800 }, 
                // חזרנו ל-Portrait כפי שהיה תקין, עם תמיכת פריסה חכמה בטבלאות
                jsPDF: { unit: 'mm', format: 'a4', orientation: 'portrait' } 
            };
...
// היסטוריית הזמנות רכש מפוצלות + הוספת כפתור "לחץ לפרטים"
...
        actionsHtml += `</div>`;
        ...
        // התוספת לבקשתך: כפתור "לחץ לפרטים" (כדי שיהיה ברור שאפשר ללחוץ על הפריט)
...
// הורדת PDF ידנית + פתיחת תצוגה מקדימה מוקפדת (תצוגה מקדימה נשארת ב-800 פיקסלים)
