...
// תבנית ה-HTML ל-PDF - גרסה משופרת עם RTL חזק + Landscape מלא + תיקון כל הבעיות
function getOrderHtmlTemplate(orderInfo) {
    ...
    if (itemsArr.length === 0) {
        ...
        itemsHtml = itemsArr.map((i, index) => `
            <tr style="background-color: ${index % 2 === 0 ? '#ffffff' : '#f8fafc'}; border-bottom: 1px solid #cbd5e1; page-break-inside: avoid;" dir="rtl">
                ...
                <!-- תיקון 4: כמות + יחידה - תמיד מספר קודם -->
    ...
    return `
        <div style="direction: rtl; font-family: Arial, sans-serif; color: #1e293b; background: white; width: 100%; max-width: 1100px; box-sizing: border-box; padding: 25px 30px; text-align: right; margin: 0 auto;" dir="rtl">
            
            <!-- כותרת עליונה - תיקון 1: יישור מושלם -->
            <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom: 3px solid #4f46e5; margin-bottom: 25px; page-break-inside: avoid;" dir="rtl">
                <tr>
                    <td style="vertical-align: middle; text-align: right; width: 55%;" dir="rtl">
                        <span style="font-size: 28px; font-weight: 900; color: #4f46e5; font-family: 'Arial Black', sans-serif;">
                            ONEFLOW <span style="color: #0f172a;">LIFE</span> <span style="font-weight: 300;">BIZ</span>
                        </span>
                    </td>
                    <td style="vertical-align: middle; text-align: left; width: 45%;" dir="rtl">
                        <h2 style="margin: 0; font-size: 26px; color: #334155; text-align: right;">הזמנת&nbsp;רכש&nbsp;<span dir="ltr" style="font-size: 18px; color:#64748b;">(Purchase Order)</span></h2>
                        <div style="margin-top: 8px; font-size: 15px; color: #0f172a; background: #f8fafc; display: inline-block; padding: 6px 14px; border-radius: 6px; border: 1px solid #e2e8f0;">מספר&nbsp;הזמנה:&nbsp;<b dir="ltr" style="color: #4f46e5;">#${orderInfo.orderId || 'חדש'}</b></div>
                    </td>
                </tr>
            </table>

            <!-- פרטי לקוח + ספק - יישור מלא -->
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px; page-break-inside: avoid;" dir="rtl">
                <tr>
                    <td style="width: 48%; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 18px; vertical-align: top; text-align: right;" dir="rtl">
                        <h3 style="margin: 0 0 12px 0; color: #4f46e5; font-size: 17px; border-bottom: 1px solid #cbd5e1; padding-bottom: 8px; text-align: right;">פרטי&nbsp;הלקוח&nbsp;(המזמין):</h3>
                        <div style="margin-bottom: 8px; text-align: right;" dir="rtl"><b>שם&nbsp;העסק:&nbsp;</b><bdi>${safeStr(currentGroup.name).replace(/ /g, '&nbsp;')}</bdi></div>
                        <div style="margin-bottom: 8px; text-align: right;" dir="rtl"><b>איש&nbsp;קשר:&nbsp;</b><bdi>${safeStr(currentUser.nickname).replace(/ /g, '&nbsp;')}</bdi></div>
                        ${branchHtml}
                        ${customerNumHtml}
                        <div style="margin-top: 14px; font-size: 13px; color: #64748b; text-align: right;" dir="rtl"><b>הופק&nbsp;ב:&nbsp;</b><span dir="ltr">${new Date().toLocaleDateString('he-IL')}&nbsp;${new Date().toLocaleTimeString('he-IL', {hour:'2-digit', minute:'2-digit'})}</span></div>
                    </td>
                    <td style="width: 4%;"></td>
                    <td style="width: 48%; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 18px; vertical-align: top; text-align: right;" dir="rtl">
                        <h3 style="margin: 0 0 12px 0; color: #0f172a; font-size: 17px; border-bottom: 1px solid #cbd5e1; padding-bottom: 8px; text-align: right;">פרטי&nbsp;הספק:</h3>
                        <div style="margin-bottom: 8px; text-align: right;" dir="rtl"><b>לכבוד:&nbsp;</b><bdi>${safeStr(orderInfo.supplierName).replace(/ /g, '&nbsp;')}</bdi></div>
                        ${phoneHtml}
                        ${emailHtml}
                    </td>
                </tr>
            ...
            <!-- טקסט מקדים - תיקון 2: לא יוצא מגבולות -->
            <div style="margin-bottom: 20px; font-size: 14.5px; line-height: 1.7; color: #334155; page-break-inside: avoid; text-align: right; max-width: 100%;" dir="rtl">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse; margin-bottom: 25px; font-size: 13.5px; border: 1px solid #cbd5e1;" dir="rtl">
                <thead>
                    <tr style="background-color: #4f46e5; color: white;">
                        <th style="padding: 12px; border: 1px solid #cbd5e1; text-align: center; width: 12%;">מק"ט</th>
                        <th style="padding: 12px; border: 1px solid #cbd5e1; text-align: right; width: 43%;">תיאור&nbsp;פריט</th>
                        <th style="padding: 12px; border: 1px solid #cbd5e1; text-align: center; width: 15%;">כמות</th>
                        <th style="padding: 12px; border: 1px solid #cbd5e1; text-align: left; width: 15%;">מחיר&nbsp;יח'</th>
                        <th style="padding: 12px; border: 1px solid #cbd5e1; text-align: left; width: 15%;">סה"כ&nbsp;שורה</th>
                    </tr>
                </thead>
                <tbody>
                    ${itemsHtml}
            ...
            <div style="border-top: 2px solid #cbd5e1; padding-top: 18px; page-break-inside: avoid; text-align: right;" dir="rtl">
                <h2 style="margin: 0; font-size: 21px; color: #0f172a;">סה"כ&nbsp;לתשלום&nbsp;משוער:&nbsp;<span dir="ltr" style="color: #4f46e5;">₪${(orderInfo.totalAmount || orderInfo.total || 0).toFixed(2)}</span></h2>
                <div style="color: #64748b; font-size: 11.5px; margin-top: 6px;">* ייתכנו&nbsp;שינויים&nbsp;במחיר&nbsp;הסופי&nbsp;בהתאם&nbsp;לשקילה&nbsp;ולמחירון&nbsp;העדכני&nbsp;בעת&nbsp;האספקה.&rlm;</div>
            </div>
        </div>
    `;
}
