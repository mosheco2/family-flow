...
window.togglePOSFullscreen = function() {
    ...
    if (!document.fullscreenElement) {
        try {
            ...
            posContainer.classList.add('bg-slate-100', 'p-4', 'z-[999999]');
            posContainer.classList.remove('pb-20', 'mt-4');
            const wrapper = posContainer.querySelector('.h-\\[85vh\\]') || posContainer.querySelector('.pos-wrapper-height');
            if(wrapper) {
...
document.addEventListener('fullscreenchange', () => {
    ...
    const wrapper = posContainer.querySelector('.h-\\[85vh\\]') || posContainer.querySelector('.h-full') || posContainer.querySelector('.pos-wrapper-height');
    
    if (!document.fullscreenElement) {
        posContainer.classList.remove('bg-slate-100', 'p-4', 'z-[999999]');
