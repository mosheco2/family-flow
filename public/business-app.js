...
// תבנית ה-HTML ל-PDF - מותאמת להדפסה לרוחב (Landscape), כולל מק"ט וסידור RTL נוקשה למניעת שיבושי טקסט ורווחים
...
         itemsHtml = '<tr><td colspan="5" style="text-align:right; padding:15px;" dir="rtl">אין פריטים להצגה</td></tr>';
    } else {
...
                <td style="padding: 10px; text-align: right; border: 1px solid #cbd5e1; font-weight: bold; color: #1e293b; white-space: pre-wrap;" dir="rtl"><bdi>${safeStr(i.name)}</bdi></td>
                <td style="padding: 10px; text-align: center; border: 1px solid #cbd5e1; font-weight: bold; color: #4f46e5; white-space: nowrap;" dir="rtl">${i.quantity}&nbsp;${safeStr(i.unit)}</td>
                <td style="padding: 10px; text-align: left; border: 1px solid #cbd5e1; white-space: nowrap;" dir="ltr">₪${parseFloat(i.price_per_unit || 0).toFixed(2)}</td>
                <td style="padding: 10px; font-weight: bold; text-align: left; border: 1px solid #cbd5e1; color: #0f172a; white-space: nowrap;" dir="ltr">₪${parseFloat(i.row_total || 0).toFixed(2)}</td>
            </tr>
        `).join('');
    }

    const customerNumHtml = orderInfo.customerNumber ? `<div style="margin-bottom: 6px; text-align: right;" dir="rtl"><b style="display:inline-block;">מספר לקוח&rlm;:&nbsp;</b><span dir="ltr" style="background-color: #eef2ff; padding: 2px 8px; border-radius: 4px; color: #4f46e5; font-weight: bold;">${safeStr(orderInfo.customerNumber)}</span></div>` : '';
    const branchHtml = orderInfo.branchName ? `<div style="margin-bottom: 6px; text-align: right;" dir="rtl"><b style="display:inline-block;">עבור סניף/מחלקה&rlm;:&nbsp;</b><bdi>${safeStr(orderInfo.branchName)}</bdi></div>` : '';
    const phoneHtml = orderInfo.supplierPhone ? `<div style="margin-bottom: 6px; text-align: right;" dir="rtl"><b style="display:inline-block;">טלפון&rlm;:&nbsp;</b><bdi dir="ltr">${safeStr(orderInfo.supplierPhone)}</bdi></div>` : '';
    const emailHtml = orderInfo.supplierEmail ? `<div style="margin-bottom: 6px; text-align: right;" dir="rtl"><b style="display:inline-block;">דוא"ל&rlm;:&nbsp;</b><bdi>${safeStr(orderInfo.supplierEmail)}</bdi></div>` : '';
...
                        <h2 style="margin: 0; font-size: 24px; color: #334155; text-align: left;">הזמנת רכש&nbsp;<span dir="ltr" style="font-size: 16px; color:#64748b;">(Purchase Order)</span></h2>
                        <div style="margin-top: 5px; font-size: 14px; color: #0f172a; background: #f8fafc; display: inline-block; padding: 4px 10px; border-radius: 4px; border: 1px solid #e2e8f0; text-align: left;">מספר הזמנה&rlm;:&nbsp;<b dir="ltr" style="color: #4f46e5;">#${orderInfo.orderId || 'חדש'}</b></div>
                    </td>
                </tr>
            </table>
...
                        <h3 style="margin: 0 0 10px 0; color: #4f46e5; font-size: 16px; border-bottom: 1px solid #cbd5e1; padding-bottom: 5px; text-align: right;">פרטי הלקוח (המזמין)&rlm;:</h3>
                        <div style="margin-bottom: 6px; text-align: right;" dir="rtl"><b style="display:inline-block;">שם העסק&rlm;:&nbsp;</b><bdi>${safeStr(currentGroup.name)}</bdi></div>
                        <div style="margin-bottom: 6px; text-align: right;" dir="rtl"><b style="display:inline-block;">איש קשר&rlm;:&nbsp;</b><bdi>${safeStr(currentUser.nickname)}</bdi></div>
                        ${branchHtml}
                        ${customerNumHtml}
                        <div style="margin-top: 10px; font-size: 12px; color: #64748b; text-align: right;" dir="rtl"><b style="display:inline-block;">הופק ב&rlm;:&nbsp;</b><span dir="ltr">${new Date().toLocaleDateString('he-IL')}&nbsp;${new Date().toLocaleTimeString('he-IL', {hour:'2-digit', minute:'2-digit'})}</span></div>
                    </td>
                    <td style="width: 4%;"></td>
                    <td style="width: 48%; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 15px; vertical-align: top; text-align: right;" dir="rtl">
                        <h3 style="margin: 0 0 10px 0; color: #0f172a; font-size: 16px; border-bottom: 1px solid #cbd5e1; padding-bottom: 5px; text-align: right;">פרטי הספק&rlm;:</h3>
                        <div style="margin-bottom: 6px; text-align: right;" dir="rtl"><b style="display:inline-block;">לכבוד&rlm;:&nbsp;</b><bdi>${safeStr(orderInfo.supplierName)}</bdi></div>
                        ${phoneHtml}
                        ${emailHtml}
                    </td>
                </tr>
...
                <strong style="display:block; margin-bottom:4px;">שלום רב,&rlm;</strong>
                <span>מצ"ב פירוט הזמנת רכש מאושרת ממערכת ההזמנות שלנו.&nbsp;נא לספק את הסחורה המפורטת מטה בהקדם האפשרי ולפי תנאי הסחר והמחירון שסוכמו.&rlm;</span>
            </div>
...
                <h2 style="margin: 0; font-size: 20px; color: #0f172a; text-align: right;">סה"כ לתשלום משוער&rlm;:&nbsp;<span dir="ltr" style="color: #4f46e5;">₪${(orderInfo.totalAmount || orderInfo.total || 0).toFixed(2)}</span></h2>
...
// הורדת PDF ידנית מהתצוגה המקדימה - פותר את בעיית ה-PDF הריק והחיתוך
