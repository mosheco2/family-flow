...
// תבנית ה-HTML ל-PDF - נבנתה מחדש עם טבלאות קשיחות למניעת קפיצת סימני פיסוק, ריווחים וגלישות עמוד
...
         itemsHtml = '<tr><td colspan="5" style="text-align:right; padding:10px;">אין&nbsp;פריטים&nbsp;להצגה</td></tr>';
    } else {
         itemsHtml = itemsArr.map((i, index) => `
            <tr style="background-color: ${index % 2 === 0 ? '#ffffff' : '#f8fafc'};">
                <td style="padding: 8px; border: 1px solid #cbd5e1; text-align: center; color: #64748b;">${safeStr(i.sku || '-')}</td>
                <td style="padding: 8px; text-align: right; border: 1px solid #cbd5e1; font-weight: bold; color: #1e293b;">${safeStr(i.name).split(' ').join('&nbsp;')}</td>
                <td style="padding: 8px; text-align: center; border: 1px solid #cbd5e1; font-weight: bold; color: #4f46e5;">${i.quantity}&nbsp;${safeStr(i.unit).split(' ').join('&nbsp;')}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #cbd5e1;" dir="ltr">₪${parseFloat(i.price_per_unit || 0).toFixed(2)}</td>
                <td style="padding: 8px; font-weight: bold; text-align: left; border: 1px solid #cbd5e1; color: #0f172a;" dir="ltr">₪${parseFloat(i.row_total || 0).toFixed(2)}</td>
            </tr>
        `).join('');
    }

    return `
        <div style="font-family: Arial, sans-serif; color: #1e293b; background: white; width: 800px; margin: 0 auto; padding: 30px; direction: rtl;" dir="rtl">
            
...
                        <img src="/logo.png" style="height: 30px; vertical-align: middle; margin-left: 10px;" onerror="this.style.display='none'">
                        <span style="font-size: 24px; font-weight: 900; color: #4f46e5; vertical-align: middle;">
                            ONEFLOW <span style="color: #0f172a;">LIFE</span> <span style="font-weight: 300;">BIZ</span>
                        </span>
                    </td>
                    <td style="width: 50%; text-align: left; vertical-align: middle;">
                        <div style="font-size: 20px; font-weight: bold; color: #334155; margin-bottom: 4px;">הזמנת&nbsp;רכש</div>
                        <div style="font-size: 12px; color: #64748b; margin-bottom: 8px;">Purchase Order</div>
                        <div style="font-size: 13px; color: #0f172a; background: #f8fafc; display: inline-block; padding: 4px 8px; border: 1px solid #e2e8f0; border-radius: 4px;">
                            <span style="font-weight: bold;">מספר&nbsp;הזמנה:</span>&nbsp;<span dir="ltr" style="color: #4f46e5; font-weight: bold;">#${orderInfo.orderId || 'חדש'}</span>
                        </div>
                    </td>
                </tr>
            </table>

                        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;" dir="rtl">
                <tr>
                    <td style="width: 48%; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 12px; vertical-align: top;">
                        <div style="color: #4f46e5; font-size: 14px; font-weight: bold; border-bottom: 1px solid #cbd5e1; padding-bottom: 6px; margin-bottom: 8px;">פרטי הלקוח (המזמין)</div>
                        <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 13px;" dir="rtl">
                            <tr><td style="font-weight: bold; padding-bottom: 6px; width: 80px;">שם&nbsp;העסק:</td><td style="padding-bottom: 6px;">${safeStr(currentGroup.name).split(' ').join('&nbsp;')}</td></tr>
                            <tr><td style="font-weight: bold; padding-bottom: 6px;">איש&nbsp;קשר:</td><td style="padding-bottom: 6px;">${safeStr(currentUser.nickname).split(' ').join('&nbsp;')}</td></tr>
                            ${orderInfo.branchName ? `<tr><td style="font-weight: bold; padding-bottom: 6px;">עבור&nbsp;סניף:</td><td style="padding-bottom: 6px;">${safeStr(orderInfo.branchName).split(' ').join('&nbsp;')}</td></tr>` : ''}
                            ${orderInfo.customerNumber ? `<tr><td style="font-weight: bold; padding-bottom: 6px;">מס'&nbsp;לקוח:</td><td style="padding-bottom: 6px;"><span dir="ltr">${safeStr(orderInfo.customerNumber)}</span></td></tr>` : ''}
                            <tr><td style="font-weight: bold; padding-top: 6px; color: #64748b; border-top: 1px solid #e2e8f0;">הופק&nbsp;ב:</td><td style="padding-top: 6px; color: #64748b; border-top: 1px solid #e2e8f0;" dir="ltr">${new Date().toLocaleDateString('he-IL')} ${new Date().toLocaleTimeString('he-IL', {hour:'2-digit', minute:'2-digit'})}</td></tr>
                        </table>
                    </td>
                    <td style="width: 4%;"></td>
                    <td style="width: 48%; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 12px; vertical-align: top;">
                        <div style="color: #0f172a; font-size: 14px; font-weight: bold; border-bottom: 1px solid #cbd5e1; padding-bottom: 6px; margin-bottom: 8px;">פרטי הספק</div>
                        <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 13px;" dir="rtl">
                            <tr><td style="font-weight: bold; padding-bottom: 6px; width: 60px;">לכבוד:</td><td style="padding-bottom: 6px;">${safeStr(orderInfo.supplierName).split(' ').join('&nbsp;')}</td></tr>
                            ${orderInfo.supplierPhone ? `<tr><td style="font-weight: bold; padding-bottom: 6px;">טלפון:</td><td style="padding-bottom: 6px;" dir="ltr">${safeStr(orderInfo.supplierPhone)}</td></tr>` : ''}
                            ${orderInfo.supplierEmail ? `<tr><td style="font-weight: bold; padding-bottom: 6px;">דוא"ל:</td><td style="padding-bottom: 6px;" dir="ltr">${safeStr(orderInfo.supplierEmail)}</td></tr>` : ''}
                        </table>
                    </td>
                </tr>
            </table>

            <div style="margin-bottom: 15px; font-size: 13px; line-height: 1.5; color: #334155; text-align: right;">
                <b style="display:block; margin-bottom:4px;">שלום רב,</b>
...
                        <th style="padding: 8px; border: 1px solid #cbd5e1; text-align: center; width: 15%;">מק"ט</th>
                        <th style="padding: 8px; border: 1px solid #cbd5e1; text-align: right; width: 40%;">תיאור&nbsp;פריט</th>
                        <th style="padding: 8px; border: 1px solid #cbd5e1; text-align: center; width: 10%;">כמות</th>
                        <th style="padding: 8px; border: 1px solid #cbd5e1; text-align: left; width: 15%;">מחיר&nbsp;יח'</th>
                        <th style="padding: 8px; border: 1px solid #cbd5e1; text-align: left; width: 15%;">סה"כ&nbsp;שורה</th>
                    </tr>
                </thead>
                <tbody>
                    ${itemsHtml}
...
            </table>
            
                        <table width="100%" cellpadding="0" cellspacing="0" style="border-top: 2px solid #cbd5e1; padding-top: 15px;" dir="rtl">
                <tr>
                    <td style="text-align: right; vertical-align: top; padding-top: 5px;">
                        <div style="color: #64748b; font-size: 11px;">* ייתכנו שינויים קלים במחיר הסופי בהתאם לשקילה ולמחירון העדכני.</div>
                    </td>
                    <td style="text-align: left; vertical-align: top;">
                        <table cellpadding="0" cellspacing="0" align="left" dir="rtl">
                            <tr>
                                <td style="font-size: 18px; font-weight: bold; color: #0f172a; padding-left: 10px;">סה"כ&nbsp;לתשלום&nbsp;משוער:</td>
                                <td style="font-size: 18px; font-weight: bold; color: #4f46e5;" dir="ltr">₪${(orderInfo.totalAmount || orderInfo.total || 0).toFixed(2)}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
...
        actionsHtml += `</div>`;
        ...
        // התוספת לבקשתך: הוספת הכפתור "לחץ לפרטים"
...
                    <h4 class="font-bold text-slate-800 text-sm flex items-center gap-2 flex-wrap">
                        ...
                        <span class="text-[10px] text-indigo-500 bg-indigo-50 border border-indigo-100 px-2 py-0.5 rounded-full shadow-sm hover:bg-indigo-100 transition animate-pulse"><i class="fa-solid fa-hand-pointer mr-1"></i> לחץ לפרטים</span>
                    </h4>
