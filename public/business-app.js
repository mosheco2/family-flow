...
                        <div style="display: inline-block; padding: 10px 20px; border-radius: 12px;">
...
            // יצירת אלמנט קיים ב-DOM אך ללא גובה כדי שהדפדפן יצלם אותו כהלכה
...
            if (!isLoaded) throw new Error('PDF library failed to load');
            ...
            // התיקון הקריטי למניעת דף ריק בהורדה: 
            // שימוש ישיר ב-contentDiv הגלוי כדי שהספרייה תצלם מה שעל המסך
