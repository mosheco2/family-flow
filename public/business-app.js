...
            
            // פתרון מושלם לדף הלבן ברקע - מזינים ישירות את המחרוזת לספרייה
            const opt = { 
                margin: 0, 
                filename: 'order.pdf', 
...
    // הפתרון הסופי לדף הריק: 
    // צילום ישיר של חלון התצוגה המקדימה שמוצג מול העיניים (contentDiv) 
...
            };
            ...
            // צילום האלמנט שגלוי פיזית במסך - מונע PDF לבן לחלוטין
