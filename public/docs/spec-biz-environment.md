# מפרט טכני מקיף — סביבת BIZ (WEFLOWZ BIZ)

> מסמך זה מתאר את מלוא הפונקציונליות של סביבת BIZ במערכת WEFLOWZ Life.  
...
- יתרה Flw שנצברו מפעילות קהילתית
