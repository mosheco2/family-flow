...
introStyle.innerHTML = `
    ...
    /* כיבוי זמני של אנימציות hover על אלמנטים מוארים כדי לא לשבש את הסיור */
...
function startAdminTour() {
    ...
    intro.setOptions({
        ...
        steps: [
            ...
            { element: '#tour-fab-btn', title: "הוספה מהירה ⚡", intro: "לחיצה על הפלוס כאן תאפשר לכם לרשום הוצאה או הכנסה מכל מסך באפליקציה.", position: 'top' },
