# אפיון: הזמנת שולחנות ללקוחות WEFLOWZ

## 🎯 מטרה
הוספת ממשק הזמנת שולחנות עם זמינות בזמן-אמת עבור לקוחות משפחה המקושרים לעסקי מסעדה/בית קפה דרך אפליקציית WEFLOWZ.
...
- [ ] SMS verification מחדש כאשר לוקח הזמנה דרך WEFLOWZ (כמו בStorefront)
