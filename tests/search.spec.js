/**
 * search.spec.js
 * Module: קהילה — הגדרות מנהל והסרת עסק
 * Coverage: COM-11..12
 *
 * Run:
...
// ═══════════════════════════════════════════════════════════════════════════════
// COM-11..12 — הגדרות מנהל קהילה והסרת עסק
// ═══════════════════════════════════════════════════════════════════════════════
test.describe('הגדרות מנהל קהילה (COM-11..12)', () => {

  test('[COM-11] קהילה — הגדרות מנהל קהילה', async ({ page }) => {
    test.skip(true, 'דורש הכנת נתונים ידנית');
  });

  test('[COM-12] קהילה — הסרת עסק', async ({ page }) => {
    test.skip(true, 'דורש הכנת נתונים ידנית');
  });
});
