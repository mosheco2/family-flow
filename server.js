...
app.get('/setup-db', async (req, res) => {
  try {
    ...
    // Shopping List (Status: 'requested' | 'pending' | 'in_cart' | 'bought')
    ...
    // Seed
    res.send('<h1>System Ready v6.1 🚀</h1><a href="/">Go Home</a>');
...
app.post('/api/shopping/add', async (req, res) => {
    ...
    try {
        ...
        // Logic: Admin -> Pending (Active List), Member -> Requested
