...
app.get('/setup-db', async (req, res) => {
  try {
    ...
    // Shopping Tables (Updated Phase 3)
    ...
    await seedQuizzes(); 
    res.send('<h1>Oneflow Life System Ready (Phase 3 Complete) 🚀</h1>');
...
app.post('/api/academy/submit', async (req, res) => {
    ...
    try {
        await client.query('BEGIN');
        // Record assignment attempt (optional, simplified for now)
        if(score >= 80) {
